...
# AUTHORS:
# Connor Mcnamee (Last edit: 3/25/23)
...
#### FIGURE 1: RECREATED GRAPH WITH CAPTION MASKED ####
...
image_write(picture, path = here::here("army-mortality-causes", "01_caption_masked.png"), format = "png")


#### FIGURE 2: FULL UNMASKED ####
...
image_write(img, path = here::here("army-mortality-causes", "02_full_unmasked.png"), format = "png")
