...
world <- read_xlsx(here::here("pop-growth-density", "popg.xlsx")) 
...
png(here::here("pop-growth-density", "tempgraph.png"),width=1100,height=700)
...
original <- image_read(here::here("pop-growth-density", "tempgraph.png"))
minimap <- image_read(here::here("pop-growth-density", "minimap.png"))
...
image_write(fig05, path = here::here("pop-growth-density", "05_full_unmasked.png"), format = "png")
...
image_write(fig02, path = here::here("pop-growth-density", "02_xlabel_unmasked.png"), format = "png")
...
image_write(fig03, path = here::here("pop-growth-density", "03_ylabel_unmasked.png"), format = "png")
...
image_write(fig04, path = here::here("pop-growth-density", "04_map_unmasked.png"), format = "png")
