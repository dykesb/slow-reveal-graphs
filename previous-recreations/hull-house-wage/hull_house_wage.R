...
#
# DESCRIPTION:
# This code is for the Hull House Wage Map of a section of Chicago by Florence Kelley.  
...
#topleft
polygon(c(190.8, 207.6, 207.6, 190.8), c(50, 50, 130, 130), border = "#77997e", col = "#77997e")
polygon(c(224.4, 207.6, 207.6, 224.4), c(50, 50, 70, 70), border = "#e8c55c", col = "#e8c55c")
polygon(c(224.4, 207.6, 207.6, 224.4), c(130, 130, 70, 70), border = "#77997e", col = "#77997e")
polygon(c(224.4, 241.2, 241.2, 224.4), c(130, 130, 50, 50), border = "#e8c55c", col = "#e8c55c")
polygon(c(258, 241.2, 241.2, 258), c(50, 50, 130, 130), border = "#77997e", col = "#77997e")
polygon(c(258, 275, 275, 258), c(50, 50, 90, 90), border = "#e8c55c", col = "#e8c55c")
