...
eugenics <- read_xlsx(here::here("Eugenics_Graph","EugenicsData.xlsx")) %>% 
...
ggplot(eugenics, aes(x = Percent, y = reorder(Country, -Percent))) + 
  ...
  geom_rect(ymin = 0.7, ymax = 1.3, xmin = 305, xmax = 315, color = "black", fill = "#eefaff", size = 0.3) +
  geom_vline(xintercept = 100, size = 0.2) +
  geom_text(data = eugenics %>% filter(Group <= 1), aes(label = Label), size = 2.3, family = "IM Fell", fontface = "italic", hjust = -0.05, color = "#3a4247") + #keep size = 2 for when export image
  coord_cartesian(clip = "off") +
  scale_y_discrete(expand = c(0.03,0.03)) + 
  scale_x_continuous(breaks = seq(0,300,10), expand = c(0,0), labels = c("0", " ", "20", " ", "40", " ", "60", " ", "80", " ", "100", " ", "120", " ", "140", " ", "160", " ", "180", " ", "200", " ", "220", " ", "240", " ", "260", " ", "280", " ", "300"), sec.axis = dup_axis()) +
  labs(title = "ALL TYPES OF SOCIAL INADEQUACY", 
...
ggplot(eugenics, aes(x = Percent, y = reorder(Country, -Percent))) + 
  ...
  geom_rect(ymin = 0.7, ymax = 1.3, xmin = 305, xmax = 315, color = "black", fill = "#eefaff", size = 0.3) +
  geom_vline(xintercept = 100, size = 0.2) +
  geom_text(data = eugenics %>% filter(Group <= 2), aes(label = Label), size = 2.3, family = "IM Fell", fontface = "italic", hjust = -0.05, color = "#3a4247") + #keep size = 2 for when export image
  coord_cartesian(clip = "off") +
  scale_y_discrete(expand = c(0.03,0.03)) + 
  scale_x_continuous(breaks = seq(0,300,10), expand = c(0,0), labels = c("0", " ", "20", " ", "40", " ", "60", " ", "80", " ", "100", " ", "120", " ", "140", " ", "160", " ", "180", " ", "200", " ", "220", " ", "240", " ", "260", " ", "280", " ", "300"), sec.axis = dup_axis()) +
  labs(title = "ALL TYPES OF SOCIAL INADEQUACY", 
...
ggplot(eugenics, aes(x = Percent, y = reorder(Country, -Percent))) + 
  ...
  geom_rect(ymin = 0.7, ymax = 1.3, xmin = 305, xmax = 315, color = "black", fill = "#eefaff", size = 0.3) +
  geom_vline(xintercept = 100, size = 0.2) +
  geom_text(data = eugenics %>% filter(Group <= 3), aes(label = Label), size = 2.3, family = "IM Fell", fontface = "italic", hjust = -0.05, color = "#3a4247") + #keep size = 2 for when export image
  coord_cartesian(clip = "off") +
  scale_y_discrete(expand = c(0.03,0.03)) + 
  scale_x_continuous(breaks = seq(0,300,10), expand = c(0,0), labels = c("0", " ", "20", " ", "40", " ", "60", " ", "80", " ", "100", " ", "120", " ", "140", " ", "160", " ", "180", " ", "200", " ", "220", " ", "240", " ", "260", " ", "280", " ", "300"), sec.axis = dup_axis()) +
  labs(title = "ALL TYPES OF SOCIAL INADEQUACY", 
