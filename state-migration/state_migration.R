...
#### creating alaska png ####
png(here::here("state-migration", "minor-areas", "alaska.png"),width=120,height=80)
alaska <- plot_usmap(
  regions = c("state"),
  include = c("Alaska"),
  color = "black",
...
#### creating hawaii png ####
png(here::here("state-migration", "minor-areas", "hawaii.png"),width=65,height=50)
hawaii <- plot_usmap(
  regions = c("state"),
  include = c("Hawaii"),
  color = "black",
...
puerto_rico <- image_graph(width = 65, height = 50)
...
image_write(puerto_rico, path = here::here("state-migration", "minor-areas", "pr.png"), format = "png")


#### creating baseline map ####
map <- map_data("state")
types <- read_xlsx(here::here("state-migration", "migration_1935.xlsx"))
...
png(here::here("state-migration", "unfinished_rate_map.png"),width=2600,height=3300)
print(ggarrange(gap,
...
original <- image_read(here::here("state-migration", "unfinished_rate_map.png"))
alaska <- image_read(here::here("state-migration", "minor-areas", "alaska.png"))
hawaii <- image_read(here::here("state-migration", "minor-areas", "hawaii.png"))
pr <- image_read(here::here("state-migration", "minor-areas", "pr.png"))
...
image_write(fig01, path = here::here("state-migration", "01_full_unmasked.png"), format = "png")
